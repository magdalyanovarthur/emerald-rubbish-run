...
import { Package, X, BarChart3, Download, Filter, Search, CalendarIcon, MapPin, Clock, User, Truck } from 'lucide-react';
  ...
  return (
    <div className="space-y-4 animate-slide-up">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Управление всеми заказами</p>
      </div>
